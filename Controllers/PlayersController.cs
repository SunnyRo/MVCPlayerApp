...
namespace PlayerApp.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Level")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Email,Level")] Player player)
        {
            if (id != player.Id)
            {
                return NotFound();
